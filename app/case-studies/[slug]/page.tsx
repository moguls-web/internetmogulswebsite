...
const caseStudiesData: Record<string, any> = {
  "moksha-himalaya-spa-resort": {
    ...
    category: "1Performance Marketing",
...
`,
  ...
  "the-corinthians-resort": {
    ...
    heroImage: "/tcp-banner-detail.jpg",
    logo: "/placeholder.svg?height=200&width=400",
    headline: "Driving Direct Revenue Growth Post Website Migration",
    story: `The Corinthians Resort, a premium 5-star destination in Pune, underwent a critical website domain migration which significantly impacted organic visibility, direct bookings, and brand keyword rankings. The shift disrupted traffic flow and reduced discoverability, risking higher OTA dependency and loss of direct revenue.`,
    objectives: [
      "Recover organic visibility & direct bookings after domain migration",
    ...
    results: [
      ...
      { value: "156%", label: "Growth in Organic Traffic Recovery" },
      { value: "38X", label: "ROAS achieved during peak seasonal campaigns" },
      { value: "202%", label: "Month-on-month revenue surge during festive campaigns" },
      { value: "114%", label: "Increase in website users post recovery phase" },
  ...
  "hard-rock-hotel": {
    ...
    heroImage: "/hr-1banner.jpg",
    logo: "/placeholder.svg?height=200&width=400",
    headline: "Reducing OTA Dependency Through Experience-Led Digital Growth",
    story: `Hard Rock Hotel Goa, a music-themed lifestyle resort in Calangute, aimed to increase direct bookings and reduce reliance on third-party platforms that were impacting profitability. Despite strong brand appeal, direct revenue and website conversions needed significant improvement.`,
    objectives: [
      "Increase direct bookings from the brand website",
      "Reduce dependency on third-party OTA channels",
      "Boost social engagement through experience-led content",
    ...
    challenges: [
      ...
      "Need to align music-led experiences with revenue campaigns",
      "Event-driven demand fluctuations across seasons",
      "Low visibility for non-brand, high-intent search keywords",
      "Balancing brand premium positioning with performance goals",
    ],
    results: [
      { value: "₹14.7L+ ", label: "Direct booking value generated through Google Ads" },
  ...
  "celebrity-resort": {
    title: "Celebrity Resort, Hyderabad",
    subtitle: "City Hotel · Revenue & OTA Strategy",
    category: "SEO + OTA Strategy + Performance Marketing + Social Media",
    heroImage: "/banner-tcp-inner.jpg",
    logo: "/placeholder.svg?height=200&width=400",
    headline: "Transforming Fragmented Marketing into a Revenue-Driven Growth Engine",
    story: `Celebrity Resort, a luxury 210-acre destination near Hyderabad, faced fragmented service visibility, heavy OTA dependency, and inconsistent demand patterns across leisure, weddings, and corporate segments.`,
    objectives: [
      "Increase direct bookings & reduce OTA dependency",
      "Generate qualified leads for weddings, MICE & day outings",
    ...
    challenges: [
      ...
      "Heavy reliance on OTAs impacting revenue mix",
      "Seasonal fluctuations causing inconsistent occupancy",
      "Limited conversion tracking and performance visibility",
      "Need to manage multiple revenue segments simultaneously",
      "Balancing brand storytelling with performance-driven campaigns",
    ],
    results: [
      { value: "59%", label: "Increase in Direct Booking Revenue" },
