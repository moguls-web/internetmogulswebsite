...
const OnlineCreativesGallery = () => {
  ...
  const allCreatives = [
    {
      ...
      image: '/lemontreehotels.jpg',
      title: 'Moksha Himalaya Spa Resort - Website',
    }, 
    {
      id: 3,
      category: 'restaurants-others',
      image: '/download.jpg',
      title: 'Restaurant Creative',
    },
    {
      id: 4,
      category: 'travel-tourism',
      image: '/download-1.jpg',
      title: 'Travel & Tourism Creative',
    }, 
  ]
  ...
  const categories = [
    ...
    { value: 'restaurants-others', label: 'Restaurants & Others' },
...
export default OnlineCreativesGallery
